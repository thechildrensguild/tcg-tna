let
    ...
    SelectColumns = Table.SelectColumns(TNAResponses, {
        ...
        "SPED Law", "HIPAA", "Regulatory (COMAR/OSSE)",
    ...
    RenameColumns = Table.RenameColumns(SelectColumns, {
        ...
        {"HIPAA", "Comp_HIPAA"},
        {"Regulatory (COMAR/OSSE)", "Comp_Regulatory"},
    ...
    SetTypes = Table.TransformColumnTypes(RenameColumns, {
        ...
        {"Comp_HIPAA", Int64.Type}, {"Comp_Regulatory", Int64.Type},
        {"Comp_Documentation", Int64.Type},
